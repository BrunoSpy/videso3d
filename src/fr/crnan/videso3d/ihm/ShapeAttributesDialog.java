			...
			gl_attrsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_attrsPanel.createSequentialGroup()
					.addGroup(gl_attrsPanel.createParallelGroup(Alignment.TRAILING)
						.addComponent(contourTitle, GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
						.addGroup(gl_attrsPanel.createSequentialGroup()
						...
						.addComponent(interieurTitle, GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
						.addGroup(gl_attrsPanel.createSequentialGroup()
						...
						.addGroup(gl_attrsPanel.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(opaciteInterieur, GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE))
						.addComponent(contourSurligneTitle, GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
						.addGroup(gl_attrsPanel.createSequentialGroup()
						...
						.addGroup(gl_attrsPanel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_attrsPanel.createParallelGroup(Alignment.LEADING)
								.addComponent(opaciteContourSurligne, GroupLayout.DEFAULT_SIZE, 325, Short.MAX_VALUE)
								.addGroup(gl_attrsPanel.createSequentialGroup()
									.addGroup(gl_attrsPanel.createParallelGroup(Alignment.TRAILING, false)
										...
										.addComponent(epaisseurContourSurligne, Alignment.LEADING))
									.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addComponent(interieurSurligneTitle, GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
						.addGroup(gl_attrsPanel.createSequentialGroup()
						...
						.addGroup(gl_attrsPanel.createSequentialGroup()
							...
							.addGroup(gl_attrsPanel.createParallelGroup(Alignment.LEADING)
								.addComponent(opaciteContour, GroupLayout.DEFAULT_SIZE, 337, Short.MAX_VALUE)
								.addGroup(gl_attrsPanel.createSequentialGroup()
									.addGroup(gl_attrsPanel.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(pointille, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
										.addComponent(epaisseurContour, Alignment.LEADING))
									.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addGroup(gl_attrsPanel.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(opaciteInterieurSurligne, GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)))
					.addContainerGap())
		);

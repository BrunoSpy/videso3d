...
/**
 * Renders a scalebar graphic in a screen corner.<br />
 * Modified to be in NM by default.
 * 
 * @author Patrick Murris
 * @author Bruno Spyckerelle
 * @version $Id: ScalebarLayer.java 12783 2009-11-10 04:40:50Z tgaskins $
 */
public class ScalebarLayerNM extends AbstractLayer
{
	// Units constants
	...
	public final static String UNIT_NM = "gov.nasa.worldwind.ScalebarLayer.NM";
     ...
     * or {@link #UNIT_IMPERIAL} or {@link #UNIT_NM}.
     *
	...
	public void draw(DrawContext dc)
	{
		...
		try
		{
            ...
            if(referencePosition != null)
            {
                ...
                } else if(this.unit.equals(UNIT_NM)) {
                	scaleSize *= 0.000539956803;
                	unitLabel = "NM";
                }

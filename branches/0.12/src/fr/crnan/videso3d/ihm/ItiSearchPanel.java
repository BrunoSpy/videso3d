				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(balisesField, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(lblBalisesExclues))
								.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(balisesExcluesField, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)))
						.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(lblBalisesExclues)
								.addComponent(balisesExcluesField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
